    ...
    <nav className="w-full flex bg-background py-4">
      <div className="flex flex-1 items-center">
        <Link href="/" className="flex items-center gap-2" target="_blank">
          <Logo width={24} height={24} className="text-[hsl(var(--brand))]" />
          <h1 className="whitespace-pre">Shardz by </h1>
        </Link>
        <span className="underline decoration-[hsl(var(--brand))/0.3] decoration-2 text-[hsl(var(--brand))]">
          Handz
        </span>
      </div>
        ...
        {session ? (
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56" align="end">
              ...
              <DropdownMenuItem
                onClick={() => {
                  window.open('https://handz.fun', '_blank')
                }}
              >
